    ...
    <div class="process-wrapper">
        ...
        <div id="progress-content-section">
            <div class="section-content discovery active">
                <h2>Para Colombia...</h2>
                <p>En Colombia, exactamente en la cordillera de los Andes, se encuentra el Eje Cafetero. Allá se erigen montañas, nevados, pueblos con herencia colonial y, entre otros productos agrícolas, se cultiva café, el cual ha forjado la identidad
